...
class MILPResult(genpy.Message):
  _md5sum = "0add2c3383bfb93ae8d3bb9d0bacfd8c"
...
int32[] Tasks"""
  __slots__ = ['RobotID','Humans','GoingStart','ApproachingStart','WaitingStart','ServingStart','DepotStart','GoingFinish','ApproachingFinish','WaitingFinish','ServingFinish','DepotFinish','FinishedFilling','FinishedService','DistanceWaiting','Tasks']
  _slot_types = ['int32','int32[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]','int32[]','int32[]','float64[]','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       RobotID,Humans,GoingStart,ApproachingStart,WaitingStart,ServingStart,DepotStart,GoingFinish,ApproachingFinish,WaitingFinish,ServingFinish,DepotFinish,FinishedFilling,FinishedService,DistanceWaiting,Tasks
    ...
    if args or kwds:
      ...
      if self.DepotFinish is None:
        self.DepotFinish = []
      if self.FinishedFilling is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.FinishedFilling)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.FinishedFilling))
      length = len(self.FinishedService)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.Struct(pattern).pack(*self.Tasks))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.FinishedFilling = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.Tasks = s.unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.FinishedFilling.tostring())
      length = len(self.FinishedService)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.Tasks.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.FinishedFilling = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      self.Tasks = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
