...
info.MatPath{4} = 'RobotMinVelocityProximity';
info.MatPath{5} = 'RobotMaxVelocityProximity';
info.MatPath{6} = 'RobotVelocityProximityWeight';
info.MatPath{7} = 'WaitingTime';
info.MatPath{8} = 'WaitingTimeWeight';
info.MatPath{9} = 'StartFilling';
info.MatPath{10} = 'FinishFilling';
info.MatPath{11} = 'StartServing';
info.MatPath{12} = 'FinishServing';
info.MatPath{13} = 'TimeFilling';
info.MatPath{14} = 'TimeServing';
info.MatPath{15} = 'ConfirmServing';
info.MatPath{16} = 'ConfirmFilling';
info.MatPath{17} = 'Task';
info.MatPath{18} = 'TaskFilling';
info.MatPath{19} = 'Happiness';
