...
[data.ApproachStart, info.ApproachStart] = ros.internal.ros.messages.ros.default_type('double',NaN);
...
[data.ApproachFinish, info.ApproachFinish] = ros.internal.ros.messages.ros.default_type('double',NaN);
...
[data.FinishedOperation, info.FinishedOperation] = ros.internal.ros.messages.ros.default_type('int32',1);
...
info.MatPath{5} = 'ApproachStart';
info.MatPath{6} = 'ServingStart';
info.MatPath{7} = 'DepotStart';
info.MatPath{8} = 'GoingFinish';
info.MatPath{9} = 'WaitingFinish';
info.MatPath{10} = 'ApproachFinish';
