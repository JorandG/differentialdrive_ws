...
[data.RobotProximity, info.RobotProximity] = ros.internal.ros.messages.ros.default_type('double',NaN);
...
info.MatPath{2} = 'RobotProximity';
info.MatPath{3} = 'RobotVelocity';
info.MatPath{4} = 'WaitingTime';
info.MatPath{5} = 'StartFilling';
info.MatPath{6} = 'FinishFilling';
info.MatPath{7} = 'StartServing';
info.MatPath{8} = 'FinishServing';
info.MatPath{9} = 'TimeFilling';
info.MatPath{10} = 'TimeServing';
info.MatPath{11} = 'ConfirmServing';
info.MatPath{12} = 'ConfirmFilling';
info.MatPath{13} = 'Task';
