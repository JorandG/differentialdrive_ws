...
[data.ConfirmServing, info.ConfirmServing] = ros.internal.ros.messages.ros.default_type('int32',1);
[data.ConfirmFilling, info.ConfirmFilling] = ros.internal.ros.messages.ros.default_type('int32',1);
...
info.MatPath{10} = 'ConfirmServing';
info.MatPath{11} = 'ConfirmFilling';
info.MatPath{12} = 'Task';
