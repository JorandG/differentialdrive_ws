...
% Finish Serving 1
if any(timingData >= ReAllSave.timeF(1+num_filling_boxes*3*num_agents)) && ~flags(7)
    humanData{1}.FinishServing(1) = ReAllSave.timeF(1+num_filling_boxes*3*num_agents);
    ...
    flags(7) = true;
    send(pub{1}, humanData{1});
elseif any(timingData >= ReAllSave.timeF(2+num_filling_boxes*3*num_agents)) && ~flags(8)
    humanData{2}.FinishServing(1) = ReAllSave.timeF(2+num_filling_boxes*3*num_agents);
    ...
    flags(8) = true;
    send(pub{2}, humanData{2});
elseif any(timingData >= ReAllSave.timeF(3+num_filling_boxes*3*num_agents)) && ~flags(9)
    humanData{3}.FinishServing(1) = ReAllSave.timeF(3+num_filling_boxes*3*num_agents);
...
% Finish Serving 2
if any(timingData >= ReAllSave.timeF(4+num_filling_boxes*3*num_agents)) && ~flags(16)
    humanData{1}.FinishServing(2) = ReAllSave.timeF(4+num_filling_boxes*3*num_agents);
    ...
    flags(16) = true;
    send(pub{1}, humanData{1});
elseif any(timingData >= ReAllSave.timeF(5+num_filling_boxes*3*num_agents)) && ~flags(17)
    humanData{2}.FinishServing(2) = ReAllSave.timeF(5+num_filling_boxes*3*num_agents);
    ...
    flags(17) = true;
    send(pub{2}, humanData{2});
elseif any(timingData >= ReAllSave.timeF(6+num_filling_boxes*3*num_agents)) && ~flags(18)
    humanData{3}.FinishServing(2) = ReAllSave.timeF(6+num_filling_boxes*3*num_agents);
...
% Finish Serving 3
if any(timingData >= ReAllSave.timeF(7+num_filling_boxes*3*num_agents)) && ~flags(25)
    humanData{1}.FinishServing(3) = ReAllSave.timeF(7+num_filling_boxes*3*num_agents);
    ...
    flags(25) = true;
    send(pub{1}, humanData{1});
elseif any(timingData >= ReAllSave.timeF(8+num_filling_boxes*3*num_agents)) && ~flags(26)
    humanData{2}.FinishServing(3) = ReAllSave.timeF(8+num_filling_boxes*3*num_agents);
    ...
    flags(26) = true;
    send(pub{2}, humanData{2});
elseif any(timingData >= ReAllSave.timeF(9+num_filling_boxes*3*num_agents)) && ~flags(27)
    humanData{3}.FinishServing(3) = ReAllSave.timeF(9+num_filling_boxes*3*num_agents);
...
% Finish Serving 4
if any(timingData >= ReAllSave.timeF(10+num_filling_boxes*3*num_agents)) && ~flags(34)
    humanData{1}.FinishServing(4) = ReAllSave.timeF(10+num_filling_boxes*3*num_agents);
    ...
    flags(34) = true;
    send(pub{1}, humanData{1});
elseif any(timingData >= ReAllSave.timeF(11+num_filling_boxes*3*num_agents)) && ~flags(35)
    humanData{2}.FinishServing(4) = ReAllSave.timeF(11+num_filling_boxes*3*num_agents);
    ...
    flags(35) = true;
    send(pub{2}, humanData{2});
elseif any(timingData >= ReAllSave.timeF(12+num_filling_boxes*3*num_agents)) && ~flags(36)
    humanData{3}.FinishServing(4) = ReAllSave.timeF(12+num_filling_boxes*3*num_agents);
